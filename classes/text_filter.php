...
class text_filter extends \base_text_filter {
    ...
    public function embed_question(string $embedcode): string {
        ...
        return $this->renderer->render(new \filter_embedquestion\output\embed_iframe($showquestionurl,
            $options->iframedescription));
    }
    ...
    protected function display_error(string $string, ?array $a = null): string {
        return $this->renderer->render(new \filter_embedquestion\output\error_message(
